...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference("Attachment.count") do
      post attachments_url, params: { attachment: { attach_content: @attachment.attach_content, attach_title: @attachment.attach_title } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { attach_content: @attachment.attach_content, attach_title: @attachment.attach_title } }
